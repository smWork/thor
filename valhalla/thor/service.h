  ...
  namespace thor {
    ...
    class thor_worker_t {
     ...
     protected:
      ...
      prime_server::worker_t::result_t jsonify_error(const baldr::valhalla_exception_t& exception, prime_server::http_request_t::info_t& request_info, const boost::optional<std::string>& extra=boost::none) const;
